...
# build-dynamic.mak
#
# erstellt dynamische Bibliothek libaufgabe6.so mit
...
clean:
	rm -f libaufgabe6.so fachnote.o liste.o

# eine explizite Regel zum Erstellen der Bibliothek
libaufgabe6.so: fachnote.o liste.o
	gcc -shared -o libaufgabe6.so fachnote.o liste.o
...
%.o: %.c
	gcc -c -I. -g -W -Wall -ansi -pedantic $< -fPIC